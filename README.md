...
| **Airline Supplier**                                             | Airline company providing flight schedules, fares, and seat inventory.                 | - Provide flight schedules, seat availability, and fares<br>- Confirm or reject booking requests<br>- Update flight status (delays, cancellations)<br>- Manage settlement and reconciliation                       |
